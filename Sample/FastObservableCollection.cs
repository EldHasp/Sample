...
{
    [Serializable]
    public class FastObservableCollection<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged,
                                              IDisposable
    {
        //-----------------------------------------------------
        //  Constants
        ...
        /// <summary> 
        /// Initializes a new instance of FastObservableCollection that is empty and has default initial capacity. 
        /// </summary>
        ...
        /// <remarks> 
        /// The elements are copied onto the FastObservableCollection in the
        ...
        public FastObservableCollection(FastObservableCollection<T> parent, bool notify)
            : base(parent.Items)
        {
        ...
        /// <summary>
        /// Returns an instance of <see cref="FastObservableCollection<T>"/>
        ...
        /// </summary>
        /// <returns><see cref="FastObservableCollection<T>"/></returns>
        public FastObservableCollection<T> DelayNotifications()
        {
            return new FastObservableCollection<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, true);
        }

        /// <summary>
        /// Returns a wrapper instance of an FastObservableCollection class.
        /// Calling methods of this instance will modify original collection
        /// but will not generate any notifications.
        /// </summary>
        /// <returns><see cref="FastObservableCollection<T>"/></returns>
        public FastObservableCollection<T> DisableNotifications()
        {
            return new FastObservableCollection<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, false);
        }
        ...
        protected void CheckReentrancy()
        {
            ...
            {
                throw new InvalidOperationException("FastObservableCollection Reentrancy Not Allowed");
            }
        }
        ...
        private class NotificationInfo
        {
            ...
            public NotifyCollectionChangedEventHandler Initialize()
            {
                ...
                return (sender, args) =>
                {
                    FastObservableCollection<T> wrapper = sender as FastObservableCollection<T>;
                    Debug.Assert(null != wrapper, "Calling object must be FastObservableCollection<T>");
            ...
            public FastObservableCollection<T> RootCollection { get; set; }
